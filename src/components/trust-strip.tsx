    ...
    >
      ...
      <div className="flex shrink-0 items-center gap-1.5">
        <button
          ...
          className="grid size-7 place-items-center rounded-full border border-line text-navy/50 transition-colors hover:border-navy hover:bg-sand hover:text-navy focus-visible:ring-2 focus-visible:ring-gold focus-visible:outline-none sm:size-8"
