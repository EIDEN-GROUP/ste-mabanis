...
//#region node_modules/.nitro/vite/services/ssr/assets/utils-BWXQYj3d.js
var property_1_default = "/assets/property-1-DQyK6z8k.jpg";
var property_2_default = "/assets/property-2-CZd58YcN.jpg";
var property_3_default = "/assets/property-3-C8Cpc5vm.jpg";
var property_4_default = "/assets/property-4-Bo4aBE9a.jpg";
var property_5_default = "/assets/property-5-SnkjOj_5.jpg";
var property_6_default = "/assets/property-6-DZyIU3dC.jpg";
var location_agadir_default = "/assets/location-agadir-BAxro-5z.jpg";
var location_taghazout_default = "/assets/location-taghazout-RmcIM5a6.jpg";
var location_marina_default = "/assets/location-marina-C1MOMV_Z.jpg";
var location_founty_default = "/assets/location-founty-BNj0m0hr.jpg";
var editorial_1_default = "/assets/editorial-1-Ca_xcsAX.jpg";
var images = {
	property1: property_1_default,
	property2: property_2_default,
	property3: property_3_default,
	property4: property_4_default,
	property5: property_5_default,
	property6: property_6_default,
	locationAgadir: location_agadir_default,
	locationTaghazout: location_taghazout_default,
	locationMarina: location_marina_default,
	locationFounty: location_founty_default,
	editorial1: editorial_1_default,
	teamOffice: "/assets/team-office-BsCc2sXo.jpg",
	testimonialsImage: "/assets/testimonials-C75Rt0q6.png"
};
var agency = {
	name: "STE MABANIS",
...
var properties = [
	...
	},
	{
		...
		bathrooms: 2,
		year: 2019,
		description: ["Au quatrième étage d'une résidence de standing de la Marina, cet appartement traversant offre une vue frontale sur le port de plaisance et la baie d'Agadir.", "Séjour de 45 m² prolongé par une terrasse de 22 m², trois chambres dont une suite, deux salles d'eau et un parking en sous-sol. La résidence dispose d'une piscine commune, d'une conciergerie et d'un accès direct à la promenade."],
		features: [
	...
	},
	{
		...
		bathrooms: 3,
		year: 2022,
		description: ["Dernier étage d'une résidence récente, ce penthouse s'organise autour d'une terrasse de 90 m² avec bassin et coin lounge, ouverte sur la baie et les lumières de la ville.", "Prestations soignées : menuiseries aluminium à rupture de pont thermique, sols en marbre, domotique d'éclairage, cuisine sur mesure."],
		features: [
	...
	},
	{
		...
		bathrooms: 3,
		year: 1998,
		description: ["Un riad entièrement restauré dans le respect des savoir-faire locaux : zellige posé à la main, tadelakt, boiseries de cèdre. Le patio central, planté d'agrumes, distribue les pièces de vie.", "Idéal pour un projet de maison d'hôtes ou une résidence de caractère à quelques minutes du centre."],
		features: [
	...
	},
	{
		...
		bathrooms: 2,
		year: 2017,
		description: ["Duplex traversant dans une petite copropriété calme, à proximité immédiate des écoles, commerces et de la voie express.", "Loué meublé, avec cuisine équipée, salon double hauteur et deux terrasses. Une adresse idéale pour une famille ou un séjour longue durée."],
		features: [
			"Meublé et équipé",
			"Deux terrasses",
	...
	},
	{
		...
		bathrooms: 2,
		year: 2020,
		description: ["Location longue durée dans la résidence la plus recherchée de la Marina. Appartement entièrement meublé par un architecte d'intérieur, avec accès piscine et conciergerie."],
		features: [
	...
	},
	{
		...
		bathrooms: 4,
		year: 2023,
		description: ["Sur les hauteurs de Taghazout Bay, une villa neuve posée face à l'Atlantique, livrée avec piscine à débordement et accès direct au parcours de golf.", "Un projet signé par un cabinet d'architecture casablancais, pensé pour les couchers de soleil et la lumière rasante de fin de journée."],
		features: [
			"Front d'océan",
	...
	},
	{
		...
		bathrooms: 2,
		year: 2015,
		description: ["Plateau de 240 m² en étage élevé sur l'artère la plus visible d'Agadir. Livré cloisonné en six bureaux, salle de réunion et espace d'accueil.", "Idéal pour un cabinet, une agence ou une antenne régionale. Possibilité d'aménagement sur mesure avant entrée dans les lieux."],
		features: [
...
var locations = [
	{
		...
		city: "Agadir",
		image: location_founty_default,
		intro: "Le quartier résidentiel le plus recherché d'Agadir : villas basses, rues plantées de bougainvillées, plage à pied.",
		editorial: ["Founty s'est construit lentement, à l'écart de la densité du centre. On y trouve encore des parcelles de 800 m² et des villas des années 90 que les nouveaux propriétaires transforment en maisons contemporaines.", "La proximité immédiate de la plage, des hôtels et du golf en fait le secteur préféré des familles installées à l'année comme des acheteurs de résidence secondaire."],
		lifestyle: [
		...
		investment: "Marché de la revente tendu, peu de terrains disponibles. Les villas rénovées se négocient entre 14 000 et 20 000 MAD/m² et se revendent bien.",
	...
	},
	{
		...
		city: "Agadir",
		image: location_marina_default,
		intro: "Un front de port piéton, des résidences fermées et une vue qui ne se dévalue pas.",
		editorial: ["La Marina reste le programme le plus abouti de la ville : commerces en pied d'immeuble, quais entretenus, sécurité permanente. Les appartements traversants avec vue port sont les plus liquides du marché gadiri.", "C'est aussi le secteur qui capte la demande locative saisonnière et longue durée des expatriés et des cadres en mission."],
		lifestyle: [
		...
		investment: "Rendement locatif brut observé entre 5 % et 6,5 % en longue durée. Forte demande locative de septembre à juin.",
	...
	},
	{
		...
		city: "Taghazout",
		image: location_taghazout_default,
		intro: "Le littoral surf devenu destination de villégiature : resorts, golf et villas front d'océan.",
		editorial: ["À vingt minutes au nord d'Agadir, Taghazout a changé d'échelle avec la station Taghazout Bay. Le village de pêcheurs a gardé son âme, mais les hauteurs accueillent désormais des programmes haut de gamme et des villas d'architecte.", "L'acheteur y vient pour la lumière, les vagues et un cadre encore préservé, avec une gestion locative facile hors saison."],
		lifestyle: [
		...
		investment: "Zone en développement continu. Fort potentiel de plus-value sur les biens front d'océan et location saisonnière soutenue.",
	...
	},
	{
		...
		name: "Hay Mohammadi",
		city: "Agadir",
		image: location_agadir_default,
		intro: "Le cœur résidentiel de la classe moyenne supérieure : pratique, bien desservi, familial.",
		editorial: ["Hay Mohammadi concentre les immeubles récents à taille humaine, les écoles et les commerces du quotidien. C'est le secteur où l'on trouve encore des appartements de 120 à 160 m² à des prix raisonnables.", "Un choix de bon sens pour une résidence principale ou un premier investissement locatif."],
		lifestyle: [
		...
		investment: "Le meilleur rapport rendement/risque de la ville. Vacance locative très faible sur les 3 pièces.",
	...
	},
	{
		...
		city: "Agadir",
		image: location_agadir_default,
		intro: "L'Agadir historique reconstruit : avenues larges, immeubles de rapport et locaux commerciaux.",
		editorial: ["Talborjt et l'avenue Hassan II forment le poumon économique de la ville. On y achète surtout pour du rendement : plateaux de bureaux, immeubles de rapport, commerces en pied d'immeuble.", "Les projets de requalification urbaine engagés par la commune redonnent de la valeur à des adresses longtemps délaissées."],
		lifestyle: [
		...
		investment: "Rendements bruts de 7 % à 9 % sur le commercial bien placé. Vigilance sur l'état technique des immeubles anciens.",
...
var articles = [
	{
		...
		date: "12 juin 2026",
		readTime: "6 min",
		excerpt: "Prix au m², délais de vente, profil des acquéreurs : notre lecture du premier semestre, chiffres de nos transactions à l'appui.",
		image: location_agadir_default,
		body: [
	...
	},
	{
		...
		date: "28 mai 2026",
		readTime: "8 min",
		excerpt: "Compromis, notaire, transfert de fonds, rapatriement du produit de la vente : les étapes réelles, sans jargon.",
		image: editorial_1_default,
		body: [
	...
	},
	{
		...
		date: "9 mai 2026",
		readTime: "5 min",
		excerpt: "Un bien mal positionné dès le départ perd en moyenne 9 % de sa valeur finale. Voici comment l'éviter.",
	...
	},
	{
		...
		date: "21 avril 2026",
		readTime: "7 min",
		excerpt: "Taux d'occupation, charges de copropriété, fiscalité : ce que rapporte vraiment un bien en station.",
		image: location_taghazout_default,
		body: [
	...
	},
	{
		...
		date: "3 avril 2026",
		readTime: "6 min",
		excerpt: "Écoles, trajets, budget, ambiance : notre comparatif honnête des cinq quartiers les plus demandés.",
		image: location_founty_default,
		body: [
...
var testimonials = [
	{
		...
		location: "Casablanca",
		quote: "Nous cherchions depuis un an sans rien trouver de sérieux. Yassine nous a montré quatre biens, pas quarante, et le troisième était le bon. Il connaissait l'historique du terrain mieux que le vendeur lui-même."
	},
	{
		name: "Thomas Rouvière",
		role: "Investisseur – Appartement à la Marina",
		location: "Lyon, France",
		quote: "J'achète à distance depuis la France. Visite en visio, dossier notarial préparé, quittances envoyées chaque mois. Trois ans plus tard, je n'ai toujours pas eu à prendre l'avion pour un problème."
	},
	{
		name: "Hicham Ait Baha",
		role: "Vendeur – Duplex à Hay Mohammadi",
		location: "Agadir",
		quote: "L'estimation de Nadia était 180 000 dirhams en dessous de ce qu'une autre agence m'avait annoncé. J'ai râlé. J'ai signé au prix de son estimation en cinquante-deux jours."
	},
	{
		name: "Sophie & Marc Delaunay",
		role: "Acquéreurs – Riad rénové",
		location: "Bruxelles, Belgique",
		quote: "Salma a pris le temps de nous expliquer chaque document, en français, sans jamais nous presser. C'est rare et ça change tout quand on achète dans un pays qu'on connaît mal."
	},
	{
		name: "Rachid El Ouafi",
		role: "Propriétaire – Gestion locative",
		location: "Montréal, Canada",
		quote: "Karim gère trois de mes lots depuis 2021. Zéro impayé, deux rotations de locataires bien gérées, et un reporting clair chaque trimestre. Je dors tranquille."
	},
	{
		name: "Laila Amrani",
		role: "Acquéreuse – Premier achat",
		location: "Agadir",
		quote: "Premier achat, budget serré, beaucoup de questions bêtes. Personne ne m'a fait sentir que je faisais perdre du temps à qui que ce soit."
	}
];
var stats = [
	{
		value: 18,
		suffix: " ans",
		label: "d'expérience sur le Grand Agadir"
	},
	{
		value: 640,
		suffix: "+",
	...
	},
	{
		value: 180,
		suffix: "",
		label: "lots en gestion locative"
	},
	{
		value: 74,
		suffix: " j",
...
var services = [
	{
		slug: "achat",
		title: "Achat",
		summary: "Une sélection resserrée, des visites préparées et une vérification juridique avant toute offre.",
		points: [
	...
	},
	{
		slug: "vente",
		title: "Vente",
		summary: "Estimation appuyée sur des transactions signées, reportage professionnel et diffusion coordonnée.",
		points: [
	...
	},
	{
		slug: "location",
		title: "Location",
		summary: "Recherche de locataires solvables, rédaction des baux et état des lieux contradictoire.",
		points: [
	...
	},
	{
		...
		summary: "Une valeur vénale argumentée, acceptée par les banques et les notaires de la place.",
		points: [
	...
	},
	{
		...
		summary: "Sélection de biens à rendement, calculs nets de charges et stratégie de sortie.",
		points: [
	...
	},
	{
		...
		summary: "Votre bien géré comme si vous étiez sur place, où que vous soyez dans le monde.",
		points: [
	...
	},
	{
		...
		summary: "Un interlocuteur unique, joignable, du premier appel à la remise des clés — et après.",
		points: [
...
function formatMAD(value) {
	return new Intl.NumberFormat("fr-MA", { maximumFractionDigits: 0 }).format(value).replace(/\u202f|\u00a0/g, " ");
}
...
var socials = [
	{
		label: "Instagram",
		href: "https://instagram.com/stemabanis",
		icon: "Instagram"
	},
	{
		label: "Threads",
		href: "https://threads.net/@stemabanis",
		icon: "Threads"
	},
	{
		label: "Facebook",
		href: "https://facebook.com/stemabanis",
		icon: "Facebook"
	}
];
function propertiesByLocation(slug) {
...
//#endregion
export { socials as _, formatMAD as a, values as b, getLocation as c, locations as d, properties as f, services as g, propertyTypes as h, cn as i, getProperty as l, propertiesByLocation as m, agents as n, getAgent as o, propertiesByAgent as p, articles as r, getArticle as s, agency as t, images as u, stats as v, testimonials as y };
